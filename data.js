  ...
  { id:"e191", ue:"UE19", ects:4, ecue:"19.1", title:"Formation tout au long de la vie", cm:[],
    td:[
      { label:"TD 1", sections:[
        ...
        { title:"La FTLV : de quoi parle-t-on ?", body:"Trois entrées pour cerner la notion.", list:["<b>Une perspective qui dépasse la formation initiale</b> : la FTLV désigne l'ensemble des <span class='chunk-highlight'>activités d'apprentissage qui se poursuivent tout au long de la vie</span> et permettent de développer des connaissances, des compétences et des façons d'agir. Finalités <b>personnelles, sociales, citoyennes ou professionnelles</b>.","<b>Trois dimensions : temporelle, spatiale et sociale</b> : à l'école et à l'université, en formation continue, au travail, dans des activités sociales ou associatives, en autonomie.","<b>Une pluralité de formes d'apprentissage</b> : <span class='chunk-highlight'>formel, non formel, informel</span>."] },
