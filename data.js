...
const SUBJECTS = [
  { id:"e191", ue:"UE19", ects:4, ecue:"19.1", title:"Formation tout au long de la vie", cm:[],
    td:[
      { label:"TD 1", sections:[
        ...
        { title:"Repères de vocabulaire", body:"<i>Section ajoutée en complément : ces définitions ne sont pas dans le diaporama, elles viennent des définitions européennes de référence (Commission européenne et CEDEFOP).</i>", list:["<b>Apprentissage formel</b> : dispensé dans un contexte organisé et structuré, école, université, organisme ou lieu de travail, et explicitement désigné comme un apprentissage en termes d'objectifs, de temps et de ressources. Il est <b>intentionnel</b> et débouche le plus souvent sur une validation et une certification.","<b>Apprentissage non formel</b> : intégré à des activités planifiées qui ne sont pas explicitement désignées comme de l'apprentissage, mais qui en comportent une part importante. Il est <b>intentionnel</b> de la part de l'apprenant et ne mène pas à une certification. On parle parfois d'apprentissage semi-structuré.","<b>Apprentissage informel</b> : il découle des activités de la vie quotidienne, travail, famille, loisirs. Il n'est <b>ni organisé ni structuré</b>, et le plus souvent <b>non intentionnel</b>. On l'appelle aussi apprentissage expérientiel ou fortuit.","<b>Apprenance</b> : ensemble des <b>dispositions durables</b> d'une personne à apprendre, dans toutes les situations. Ce n'est ni une méthode, ni la motivation du moment, ni le fait d'apprendre seul.","<b>VAE</b>, validation des acquis de l'expérience : dispositif permettant de faire <b>reconnaître officiellement</b> les compétences acquises par l'expérience, pour obtenir tout ou partie d'une certification, sans repasser par la formation."] },
      ...
      { q:"Qu'est-ce qu'un apprentissage formel ?", a:"Un apprentissage dispensé dans un contexte organisé et structuré, explicitement désigné comme apprentissage en termes d'objectifs, de temps et de ressources. Il est intentionnel et débouche généralement sur une certification." },
      { q:"Qu'est-ce qu'un apprentissage non formel ?", a:"Un apprentissage intégré à des activités planifiées qui ne sont pas explicitement désignées comme de l'apprentissage mais qui en comportent une part importante. Il est intentionnel, mais ne mène pas à une certification." },
      { q:"Qu'est-ce qu'un apprentissage informel ?", a:"Un apprentissage qui découle des activités de la vie quotidienne, travail, famille ou loisirs. Il n'est ni organisé ni structuré, et il est le plus souvent non intentionnel. On parle aussi d'apprentissage expérientiel ou fortuit." },
      { q:"Quel critère distingue l'apprentissage non formel de l'informel ?", a:"L'intention. Le non formel est intentionnel de la part de l'apprenant et s'inscrit dans une activité planifiée ; l'informel est le plus souvent non intentionnel et non structuré." },
      { q:"Que désigne l'apprenance ?", a:"L'ensemble des dispositions durables d'une personne à apprendre, dans toutes les situations. Ce n'est pas une méthode, ni la motivation passagère, ni le fait d'apprendre seul." },
      { q:"En quoi consiste la VAE ?", a:"La validation des acquis de l'expérience permet de faire reconnaître officiellement les compétences acquises par l'expérience, pour obtenir tout ou partie d'une certification sans repasser par la formation." }
    ], qcm:[
      { q:"Un salarié suit une formation certifiante organisée par son employeur. De quel type d'apprentissage s'agit-il ?", opts:["Informel","Formel","Non formel","Fortuit"], c:1, e:"Contexte structuré, explicitement désigné comme apprentissage, et débouchant sur une certification : c'est du formel." },
      { q:"Un enseignant apprend à gérer un conflit en observant un collègue plus expérimenté, sans que ce soit prévu. C'est :", opts:["de l'apprentissage informel","de l'apprentissage formel","une certification","de l'apprentissage non formel"], c:0, e:"Ni organisé ni structuré, et non intentionnel : c'est de l'informel, aussi appelé expérientiel." },
      { q:"Qu'est-ce qui distingue le non formel de l'informel ?", opts:["Le lieu","La durée","Le financement","L'intention de l'apprenant"], c:3, e:"Le non formel est intentionnel et intégré à une activité planifiée ; l'informel est le plus souvent non intentionnel." },
      { q:"L'apprenance désigne :", opts:["une méthode d'apprentissage","la motivation du moment","des dispositions durables à apprendre","le fait d'apprendre seul"], c:2, e:"C'est un ensemble de dispositions durables à apprendre, et non une méthode ni un état passager." },
      { q:"La VAE consiste principalement à :", opts:["faire reconnaître des acquis de l'expérience","financer une formation","entrer en formation","supprimer une certification"], c:0, e:"La validation des acquis de l'expérience fait reconnaître officiellement des compétences acquises par l'expérience." },
      ...
      { texte:"L'apprentissage ___ se déroule dans un contexte organisé et structuré, et débouche généralement sur une certification.",
        opts:["informel","formel","fortuit","non formel"], c:1,
        e:"Cadre structuré, activité explicitement désignée comme apprentissage, certification à la clé : c'est le formel." },
      { texte:"L'apprentissage ___ découle des activités de la vie quotidienne et se fait le plus souvent sans intention d'apprendre.",
        opts:["informel","non formel","formel","certifiant"], c:0,
        e:"L'informel n'est ni organisé ni structuré, et il est le plus souvent non intentionnel." },
      { texte:"L'apprentissage ___ est intégré à des activités planifiées qui ne sont pas désignées comme de l'apprentissage, mais il reste intentionnel.",
        opts:["formel","informel","fortuit","non formel"], c:3,
        e:"Le non formel est intentionnel et planifié, mais ne mène pas à une certification." },
      { texte:"La FTLV se déploie selon trois dimensions : temporelle, spatiale et ___.",
        opts:["sociale","économique","cognitive","juridique"], c:0,
        e:"Les trois dimensions sont temporelle, spatiale et sociale." },
      { texte:"L'___ désigne l'ensemble des dispositions durables d'une personne à apprendre.",
        opts:["autonomie","apprenance","assiduité","expérience"], c:1,
        e:"L'apprenance est un ensemble de dispositions durables, pas une méthode ni une motivation passagère." },
      { texte:"La ___ permet de faire reconnaître officiellement les compétences acquises par l'expérience.",
        opts:["VAP","CPF","VAE","RNCP"], c:2,
        e:"La validation des acquis de l'expérience mène à tout ou partie d'une certification, sans repasser par la formation." },
      { texte:"Dans la grille d'analyse, l'entrée « ___ » regroupe les pairs, les collègues, les tuteurs et la reconnaissance.",
        opts:["l'individu","le collectif","l'organisation","le dispositif"], c:1,
        e:"Le collectif : pairs, collègues, équipe, tuteurs, échanges, normes, reconnaissance." },
      { texte:"Dans la grille d'analyse, le temps disponible, le financement et les réformes relèvent de l'entrée « ___ ».",
        opts:["les situations de travail","le collectif","l'organisation et l'institution","l'individu"], c:2,
        e:"Cette entrée réunit temps disponible, prescriptions, hiérarchie, ressources, financement et politiques de formation." },
      { texte:"L'axe 3 du corpus porte sur les nouveaux dispositifs et l'___ de la formation.",
        opts:["évaluation","hybridation","individualisation","industrialisation"], c:1,
        e:"Axe 3 : nouveaux dispositifs et hybridation de la formation, avec le texte de Ravez." },
      { texte:"Selon Bourdoncle, la ___ peut désigner l'amélioration des compétences, la stratégie d'un groupe, ou l'universitarisation de la formation.",
        opts:["professionnalisation","qualification","certification","spécialisation"], c:0,
        e:"Bourdoncle distingue ces différents sens du mot professionnalisation." }
    ], oq:[
      ...
      { nom:"Ferrière", courant:"Axe 1 : histoire, réformes et politiques", periode:"référence à compléter",
        these:"Texte de l'axe 1 du corpus. Il éclaire l'entrée « organisation et institution » de la grille du TD : politiques de formation, réformes, cadre dans lequel la FTLV des enseignants est rendue possible ou empêchée. Le diaporama ne donne que le nom : reporte-toi à la bibliographie pour la référence exacte.",
        concepts:["histoire","réformes","politiques éducatives"],
        retenir:"Pour le TD : côté organisation et institution de la grille. Référence à compléter." },

      { nom:"Lessard et Bourdoncle", courant:"Axe 1 : histoire, réformes et politiques", periode:"Travaux des années 1990 et 2000",
        ...
        retenir:"Pour le TD : ils donnent le vocabulaire de l'axe 1. Bourdoncle distingue plusieurs sens de « professionnalisation » : amélioration des compétences, stratégie d'un groupe pour faire reconnaître son métier, universitarisation de sa formation. À mobiliser sur l'entrée « organisation et institution » de la grille." },

      { nom:"Richard Étienne", courant:"Axe 1 : histoire, réformes et politiques", periode:"Professeur émérite, université Paul-Valéry Montpellier 3",
        ...
        retenir:"Pour le TD : il fait le pont entre l'axe 1 et l'axe 2. Son analyse des situations est un exemple de « formation organisée » au sens de la diapo sur les quatre façons d'apprendre en poste, mais qui prend pour objet les situations de travail réelles." },

      { nom:"Véronique Fortun-Carillat", courant:"Axe 2 : développement professionnel et posture réflexive", periode:"Inspé de Créteil, UPEC",
        ...
        concepts:["environnements numériques","communautés virtuelles","apprentissage informel"],
        retenir:"Pour le TD : elle illustre l'apprentissage « non formel » et « informel » de la diapo sur les formes d'apprentissage, et l'entrée « collectif » de la grille. Attention, le diaporama écrit « Fortuna-Carillat » ; l'UPEC retient Fortun-Carillat." },

      { nom:"Jean-François Marcel", courant:"Axe 2 : développement professionnel et travail collectif", periode:"Université Toulouse Jean Jaurès, UMR EFTS",
        ...
        retenir:"Pour le TD : c'est l'auteur des entrées « situations de travail » et « collectif » de la grille. Il correspond aux modalités B et C de la diapo sur l'apprentissage en poste, apprendre en situation de travail et apprendre avec les autres." },

      { nom:"Claire Ravez", courant:"Axe 3 : nouveaux dispositifs et hybridation", periode:"Institut français de l'éducation, ENS de Lyon",
        ...
        concepts:["veille scientifique","formateurs d'enseignants","hybridation","identité professionnelle"],
        retenir:"Pour le TD : elle porte l'entrée « dispositif de formation » de la grille, avec la question du présentiel, de la distance et de l'hybride. Un Dossier de veille est une synthèse de travaux existants, pas une recherche originale : c'est un type de texte à lire comme tel." }
    ] },
  { id:"e192", ue:"UE19", ects:4, ecue:"19.2", title:"Sociologie de l'éducation",
    ...
    td:[
      ...
      { texte:"Pour ___, l'éducation est l'action exercée par les générations adultes sur celles qui ne sont pas encore mûres pour la vie sociale.",
        opts:["Bourdieu","Durkheim","Boudon","Parsons"], c:1,
        e:"C'est la définition de Durkheim, père fondateur de la sociologie de l'éducation en France." },
      { texte:"Le ___ désigne les ressources culturelles d'un individu, liées à son milieu social, qui influencent sa réussite scolaire.",
        opts:["capital culturel","habitus","capital scolaire","patrimoine"], c:0,
        e:"Le capital culturel est un concept de Bourdieu et Passeron." },
      { texte:"L'___ est la manière dont notre milieu social influence nos façons d'agir, de percevoir et de penser.",
        opts:["héritage","identité","habitus","éthos"], c:2,
        e:"L'habitus, chez Bourdieu, est ce que le milieu social dépose durablement en nous." },
      { texte:"La violence ___ fait apparaître comme naturelles des inégalités qui sont en réalité construites socialement.",
        opts:["scolaire","structurelle","institutionnelle","symbolique"], c:3,
        e:"La violence symbolique fait accepter l'ordre social comme allant de soi." },
      { texte:"___ reproche à Bourdieu son déterminisme et explique les inégalités par les stratégies rationnelles des familles.",
        opts:["Boudon","Passeron","Parsons","Durkheim"], c:0,
        e:"Boudon, dans « L'Inégalité des chances » (1973), raisonne en calculs coûts et bénéfices." },
      { texte:"Un ___ est un individu qui change de classe sociale, par exemple grâce à la réussite scolaire.",
        opts:["héritier","transclasse","boursier","transfuge scolaire"], c:1,
        e:"Le transclasse est celui dont la trajectoire sociale rompt avec son milieu d'origine." },
      { texte:"___ prolonge le fonctionnalisme durkheimien : l'école prépare aux rôles sociaux adultes.",
        opts:["Boudon","Bourdieu","Parsons","Passeron"], c:2,
        e:"Parsons inscrit l'école dans la fonction d'intégration sociale." },
      { texte:"Le collège unique est créé en ___.",
        opts:["1973","1970","1960","1989"], c:1,
        e:"1970, dans le contexte de massification scolaire." },
      { texte:"___ un sujet, c'est comprendre la question qu'il pose pour la transformer en véritable question de réflexion.",
  ...
  { id:"e201", ue:"UE20", ects:3, ecue:"20.1", title:"Culture numérique",
    ...
    tr:[
      ...
      { texte:"L'essor de la technologie mobile se situe en ___.",
        opts:["1989","2010","2007","2022"], c:2,
        e:"1980 les ordinateurs personnels, 1989 internet, 2007 le mobile, 2010 réseaux sociaux et big data, 2022 l'IA." },
      { texte:"L'___ régule les infrastructures et l'accès au réseau, tandis que l'autre autorité s'occupe des contenus.",
        opts:["ARCOM","CNIL","ARCEP","ANSSI"], c:2,
        e:"ARCEP pour les tuyaux, ARCOM pour ce qui circule dedans." },
      { texte:"L'___ régule les contenus et les médias en France.",
        opts:["ARCOM","ARCEP","CNIL","CSA numérique"], c:0,
        e:"ARCOM régule les contenus, ARCEP les infrastructures." },
      { texte:"Les sanctions prévues par le Digital Service Act peuvent atteindre ___ du chiffre d'affaires.",
        opts:["2 %","4 %","10 %","6 %"], c:3,
        e:"Jusqu'à 6 % du chiffre d'affaires mondial." },
      { texte:"Le ___ encadre le fonctionnement des plateformes en ligne, alors que l'autre texte protège les données personnelles.",
        opts:["RGPD","DSA","DMA","Code du numérique"], c:1,
        e:"Le DSA vise les plateformes, le RGPD vise les données personnelles de toute organisation." },
      { texte:"Selon le RGPD, une donnée personnelle est toute information permettant d'___ une personne, directement ou par croisement.",
        opts:["identifier","contacter","localiser","profiler"], c:0,
        e:"L'identification, directe ou par recoupement, est le critère." },
      { texte:"La fracture numérique comporte quatre dimensions : culturelle, économique, professionnelle et ___.",
        opts:["territoriale","générationnelle","sociale","technique"], c:2,
        e:"Culturelle, économique, sociale et professionnelle." },
      { texte:"L'___ est fonctionnelle et technique, tandis que l'usage intègre les valeurs, les normes et les besoins des individus.",
        opts:["utilisation","appropriation","pratique","manipulation"], c:0,
        e:"Utilisation, usage, pratique : trois niveaux de lecture distincts." },
      { texte:"Une ___ désigne des routines et des habitudes stabilisées, qui témoignent d'un rapport durable à l'outil numérique.",
        opts:["utilisation","pratique","compétence","procédure"], c:1,
        e:"La pratique est ce qui s'est stabilisé dans le quotidien." },
      { texte:"Le modèle économique des réseaux sociaux repose sur la monétisation des données et la captation de l'___.",
        opts:["information","audience","attention","opinion"], c:2,
