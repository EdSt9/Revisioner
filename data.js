  ...
  { id:"e201", ue:"UE20", ects:3, ecue:"20.1", title:"Culture numérique",
    cm:[
      ...
      { label:"CM2 · 04/09", sections:[
        ...
        { title:"Les rapports de référence", body:"Deux rapports importants pour comprendre les effets des écrans sur les jeunes.", list:["<b>« À la recherche du temps perdu »</b> (Élysée, avril 2024) : effets négatifs identifiés mais non tranchés, impact possible sur le neurodéveloppement.","<b>ANSES</b> (décembre 2025) : usages des réseaux sociaux et santé des adolescents.","90% des 12-17 ans utilisent le téléphone comme accès principal à internet ; 42% y passent 2 à 5h/jour.","Effets constatés : sommeil, image de soi, troubles anxiodépressifs, conduites à risque, résultats scolaires — les filles davantage touchées."] }
      ], recap:["Le DSA encadre les plateformes, le RGPD protège les données personnelles.","Sanctions DSA : jusqu'à 6% du CA.","Chaque établissement doit avoir une charte du numérique.","4 piliers pour un numérique raisonné à l'école.","Les rapports identifient des effets réels mais encore à approfondir."] }
    ],
    td:[], fc:[], qcm:[], oq:[], auteurs:[] },
